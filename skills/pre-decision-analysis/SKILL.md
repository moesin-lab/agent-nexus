...
- `../../standards/pre-decision-analysis-scratch.md` — scratch 骨架（仅 scratch 硬触发时）
- `../../standards/pre-decision-analysis.md` — 产物合格条件与反模式
...
- **Scratch 协作**：讨论复杂 / 跨会话时起 scratch（路径 C），遵循 `docs/dev/standards/pre-decision-analysis-scratch.md` 骨架
