...
type: index
status: active
summary: 开发文档、产品文档与运维文档的总导航与阅读顺序
tags: [navigation]
related:
  - dev/README
  - product/README
...
本项目的文档分为三个入口：**开发文档**、**产品文档** 与 **运维文档**。三者面向不同读者，结构、语气、维护节奏都不同，**不要混放**。
...
入口：[`product/README.md`](product/README.md)。

### `ops/` — 运维文档

介于开发与产品之间，给"部署并运维这个系统的人"看。入口：[`ops/runbook.md`](ops/runbook.md)。

## 文档风格

- **语言**：当前只写中文。双语翻译等产品入口稳定后统一处理。
