...
| 集成新 agent 后端 | `docs/dev/spec/agent-runtime.md` + `docs/dev/spec/claude-code-cli-contract.md` |
| 改权限/身份 | `docs/dev/spec/auth.md` |
| 改工具边界 | `docs/dev/spec/tool-boundary.md` |
| 改密钥处理 | `docs/dev/spec/secrets.md` |
| 改脱敏规则 | `docs/dev/spec/redaction.md` |
| 改幂等/去重 | `docs/dev/spec/idempotency.md` |
| 威胁模型与跨分区安全索引 | `docs/dev/spec/security.md` |
